        ...
        <View style={styles.headerRow}>
          ...
          {statusLabel ? (
            <View style={[styles.badgeBase, statusStyle]}>
              <Text style={[styles.badgeTextBase, statusTextStyle]} numberOfLines={1}>
                {statusLabel}
              </Text>
            </View>
          ) : null}
...
const styles = StyleSheet.create({
  // this outer wrapper gives the “floating” effect
  cardOuter: {
    marginBottom: 24,
    borderRadius: 16,
  ...
  // inner card is the visible white panel with border
  cardInner: {
    borderRadius: 12,
    backgroundColor: "#ffffff",
    borderWidth: 1,
    borderColor: "#fde68a", // soft yellow border like your design
